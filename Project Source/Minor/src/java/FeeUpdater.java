 ...
 */
public class FeeUpdater extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int studentfee = Integer.parseInt(request.getParameter("fee"));
