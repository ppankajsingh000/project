<%-- 
    Document   : MidSemCounter
    Created on : Feb 21, 2016, 8:44:06 AM
...
<html>
    ...
    <body>
        ...
        String name ="";
            ...
            String branch = (String)session.getAttribute("midbranch");
